...
async function getBeers() {
    ...
    // ? for if it has use it  , : if it not use this instead
    beers.forEach(beer => {
       beerHtml += `
...
//     const beerNametag = document.createElement('h3')
//     beerNametag.innerHTML += beers[i].name
//     beersDiv.appendChild(beerNametag)
// }